...
/**
 * 
 * Imagine you have a special keyboard with all keys in a single row. The layout
 * of characters on a keyboard is denoted by a string S1 of length 26. S1 is
 ...
 * |j-i|, where || denotes absolute value.
 * 
 * Write a function solution(), that given a string S1 that describes the
 * keyboard layout and a string S2, returns an integer denoting the time taken
 * to type string S2.
 * 
 * Examples:
 * 
